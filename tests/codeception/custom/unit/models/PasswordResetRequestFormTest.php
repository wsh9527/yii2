...
namespace tests\codeception\custom\models;

use Yii;
use tests\codeception\custom\unit\DbTestCase;
use custom\models\PasswordResetRequestForm;
    ...
    public function fixtures()
    {
        return [
            'user' => [
                ...
                'dataFile' => '@tests/codeception/custom/unit/fixtures/data/models/user.php'
            ],
        ];
    }
